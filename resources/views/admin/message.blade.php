        ...
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                ...
                <div class="navi">
                    <ul>
                        ...
                        <li class="active"><a href="/admin/messages"><i class="fa fa-server" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Message</span></a></li>
            ...
            <div class="col-md-10 col-sm-11 display-table-cell v-align">
                ...
                <div class="user-dashboard">
                    <h2 class="mb-4 text-center">Daftar Pesan Masuk</h2>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $msg->email }}</td>
                                        <td>{{ $msg->pesan }}</td>
                                        <td>{{ \Carbon\Carbon::parse($msg->created_at)->translatedFormat('d F Y, H:i') }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
